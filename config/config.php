...
$base_url = 'https://thànhchimnhỏ.com/'; // Thay url web bạn
...
class CMSNT
{
    ...
    function connect()
    {
        if (!$this->ketnoi)
        {
            $this->ketnoi = mysqli_connect('localhost', 'cardvipf_trumthe', 'cardvipf_trumthe', 'cardvipf_trumthe') or die ('Vui lòng kết nối đến DATABASE');
